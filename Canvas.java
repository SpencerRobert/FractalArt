...
if(args.length!=2)
{
System.out.println("Incorrect number of arguments: " + args.length + " supplied, 2 needed");
System.out.println("Usage: java TestCanvas X-dimension Y-dimension\n");
System.out.println("Example: java TestCanvas 1024 1024\n");
System.exit(0);
}
...
pic.drawLine(x1,y1,x2,y1,0,255,0);
pic.drawLine(x1,y2,x2,y2,0,255,0);
pic.drawLine(x1,y1,x1,y2,0,255,0);
pic.drawLine(x2,y1,x2,y2,0,255,0);
// left and right diagonal red lines
pic.drawLine(x1,y2,x2,y1,255,0,0);
pic.drawLine(x1,y1,x2,y2,255,0,0);
...
pic.drawLine(474,314,504,314,0,255,0);
pic.drawLine(504,314,520,337,255,0,0);
pic.drawLine(520,337,504,260,0,0,255);
pic.drawLine(504,260,474,314,0,0,0);
pic.show();
